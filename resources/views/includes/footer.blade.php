<footer class="site-footer">
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            </script><script>document.write(new Date().getFullYear());</script> All Rights Reserved | Developed by 
            <i class="icon-heart text-warning" aria-hidden="true"></i> <a href="http://tanvirbhuiyan.info" target="_blank" >
                Tanvir Bhuiyan</a> <i class="icon-heart text-warning" aria-hidden="true"></i>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
  ...
  <script data-ad-client="ca-pub-1822170344240075" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>

  
  <script src="{{asset('public/frontEnd/')}}/js/mediaelement-and-player.min.js"></script>
